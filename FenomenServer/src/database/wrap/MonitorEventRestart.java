 ...
 * <table border=1>
 * 	<tr>
 * 		<th>monitor_event_restart</th>  <th>POJO</th>  <th>Description</th>
 * 	</tr>
 * 	<tr>
 * 		<td>id</td>  <td>id</td>  <td> уникальный идентификатор в базе </td>
 * 	</tr>
 * 	<tr>
 * 		<td>id_module_restart</td>  <td>idModuleRestart</td>  <td> код из module_restart</td>
 * 	</tr>
 * 	<tr>
...
@Table(name="monitor_event_restart")
public class MonitorEventRestart {
	@Id
	@GeneratedValue
	@Column(name="id")
	private int id;
	@Column(name="id_module_restart")
	private int idModuleRestart;
	...
	public int getIdModuleRestart() {
		return idModuleRestart;
	}
	public void setIdModuleRestart(int idModuleRestart) {
		this.idModuleRestart = idModuleRestart;
	}
}

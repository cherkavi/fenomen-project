 ...
 * <table border=1>
 * 	<tr>
 * 		<th>monitor_event_alarm</th>  <th>POJO</th>  <th>Description</th>
 * 	</tr>
 * 	<tr>
 * 		<td>id</td>  <td>id</td>  <td> уникальный идентификатор в базе </td>
 * 	</tr>
 * 	<tr>
 * 		<td>id_module_alarm</td>  <td>idModuleAlarm</td>  <td> код из module_alarm</td>
 * 	</tr>
 * 	<tr>
...
@Table(name="monitor_event_alarm")
public class MonitorEventAlarm {
	@Id
	@GeneratedValue
	@Column(name="id")
	private int id;
	@Column(name="id_module_alarm")
	private int idModuleAlarm;
	...
	public int getIdModuleAlarm() {
		return idModuleAlarm;
	}
	public void setIdModuleAlarm(int idModuleAlarm) {
		this.idModuleAlarm = idModuleAlarm;
	}

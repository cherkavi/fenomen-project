...
public class Connector {
	...
	private Class<?>[] classesOfDatabase=new Class[]{
												   ...
												   Monitor.class,
												   MonitorSettingsRestart.class,
												   MonitorSettingsInformation.class,
												   MonitorSettingsAlarm.class,
												   MonitorSettingsHeartBeat.class,
												   MonitorEventInformation.class,
												   MonitorEventRestart.class,
												   MonitorEventHeartBeat.class,
												   MonitorEventAlarm.class,
												   MonitorEventResolve.class
												   };

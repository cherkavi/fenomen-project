...
public class EventFilterAlarm {
	 ...
	 * @param moduleAlarmWrap - объект, который был сохранен в базе данных как входящее тревожное сообщение от модуля
	 * @return 
	 * 	<ul>
	...
	public boolean notifyAlarmEvent(ConnectWrap connector, ModuleAlarmWrap moduleAlarmWrap){
		...
		try{
			...
			returnValue=true;
			if(needNotify==true){
				logger.debug("оповестить Worker, который соответствует данному потоку о событии Alarm, которое нужно послать монитору");
